# dab_project_databricks

The 'dab_project_databricks' project was generated by using the default-python template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] dab_project_databricks_job` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/dab_project_databricks.job.yml). The schedule
